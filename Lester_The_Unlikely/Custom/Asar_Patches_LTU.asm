...
; Note: Put your custom routine/data macros, references to them, and defines in this file from within the LTU_InsertIntegratedPatches and LTU_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro LTU_InsertIntegratedPatches()
...
macro LTU_ApplyPatchesPostAssembly()
...
macro LTU_HandleDefaultPatches()
