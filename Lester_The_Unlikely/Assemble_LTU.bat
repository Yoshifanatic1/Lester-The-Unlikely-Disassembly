...
set asarVer=asar
set GAMDID="LTU"
set FolderName="Lester_The_Unlikely"
set ROMVer=
set ROMExt=.sfc
set HackCheck=""
set HackName=""
...
echo Valid options: "LTU_U" "LTU_J"
...
if "%Input1%" equ "LTU_U" goto :USA
if "%Input1%" equ "LTU_J" goto :Japan
...
:USA
set ROMVer=(U)
set ROMNAME=Lester The Unlikely
goto :Assemble

:Japan
set ROMVer=(J)
set ROMNAME=Odekake Lester - Lelele no Le
